          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="ml-0 md:ml-16 col-span-1 md:col-span-2">
              ...
              <div className="flex space-x-4">
                <a href="www.facebook.com/archspaceinterio21" className="text-primaryRed hover:text-blue-600">
                  <Facebook size={24} />
                  <span className="sr-only">Facebook</span>
                </a>
                <a href="www.instagram.com/archspace_interio/" className="text-primaryRed hover:text-blue-600">
                  <Instagram size={24} />
                  <span className="sr-only">Instagram</span>
                </a>
                <a href="www.linkedin.com/in/designer-yash227989/" className="text-primaryRed hover:text-blue-600">
                  <Linkedin size={24} />
                  <span className="sr-only">LinkedIn</span>
                </a>
                <a href="www.behance.net/asi21" className="text-primaryRed hover:text-blue-600">
                  <BsBehance size={24}/>
