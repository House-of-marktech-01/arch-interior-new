...
import { ChevronRight, Home, PenTool, Building2, Hammer, Mountain, Users } from 'lucide-react'
...
const services = [
  ...
  {
    title: 'Construction',
    description: 'Bringing architectural visions to life with precision and care.',
  ...
  },
  {
    ...
    description: 'Transforming landscapes into thriving communities and spaces.',
    icon: <Mountain className="h-6 w-6" />,
    image: livingroom3,
  },
  {
    title: 'Consultancy',
    description: 'Expert advice to guide your project from concept to completion.',
                ...
                >
                  ...
                  <div className="px-4 py-5 sm:p-6">
                    <div className="flex items-center">
                      ...
                      <h3 className="ml-3 text-2xl font-medium text-gray-900 font-cormorant">{service.title}</h3>
                    </div>
