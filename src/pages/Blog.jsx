    ...
    <div>
      <header>
        ...
        >
          ...
          />
          <div className="relative z-10 flex items-center justify-center w-full h-full bg-black bg-opacity-0 rounded-lg shadow-lg">
            <div className="text-center">
              <motion.h1
                className="text-6xl mb-4 tracking-wide text-white leading-tight font-cormorant"
              ...
              <motion.p
                className="text-xl mb-6 italic font-cormorant text-white"
                initial={{ y: 20, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
